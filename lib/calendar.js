  ...
  Calendar.prototype._bindDrag = function() {
    this.el.on('dragstart.calendar', '.event', (function(_this) {
      return function(e) {
        ...
        if (event.acrossDay && !_this.isAllDayEvent(event)) {
        ...
        return setTimeout(function() {
          ...
          return _this.el.find(".event[data-id=" + event.id + "]").css({
            opacity: 0.4
          });
        }, 0);
      };
    ...
    this.el.on('dragover.calendar', '.day', (function(_this) {
      return function(e) {
        var $event, $target, differ, event, id, index;
        e.preventDefault();
        id = _this.dragging;
        event = _this.findEvent(id);
        ...
        return $('.day').slice(index, differ + index + 1).addClass('dragover');
      };
    })(this));
    return this.el.on('drop.calendar', '.day', (function(_this) {
      return function(e) {
        var $event, $target, differ, event, id, newDate;
        e.preventDefault();
        ...
        return _this.trigger('eventchanged', [event]);
      };
    })(this));
  };
